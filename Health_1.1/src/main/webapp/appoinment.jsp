 ...
 */
		...
		if (!mobile_valid.value == null || mobile.value == "") {
	...
	<div class="appoinments">
		...
		<form name="myform" method="post" onsubmit="return validate()"
			...
			<label for="fname"><br> Name<br></label> <input type="text"
				...
				id="mobile" name="mobileno" placeholder="+91"> <label
				for="dob"><br>Appoinment Date:<br> <br></label> 
				
				<input
				type="date" id="appoinment" class="date" name="appoinmentdate"
				placeholder="DD/MM/YY" min="2022-02-26"><br> <br>GENDER <br> <br>
